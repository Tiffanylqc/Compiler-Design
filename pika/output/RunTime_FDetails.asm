        ...
        Label        -function-definition-1-array_rebuild-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-14-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-14-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-14-loop-start 
        Label        -clone-element-14-end     
        PushD        $record-creation-temp     
        LoadI                                  
        Duplicate                              
        JumpFalse    $$null-array              
        ...
        PushD        -function-definition-1-array_rebuild-start 
        StoreI                                 
        PushI        4                         
        PushI        5                         
        Multiply                               
