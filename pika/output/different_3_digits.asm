        ...
        Label        -compare-boolAnd-15-arg1  
        Label        -compare-boolAnd-13-arg1  
        Label        -compare-notequal-11-arg1 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% i
        LoadI                                  
        Label        -compare-notequal-11-arg2 
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% k
        LoadI                                  
        Label        -compare-notequal-11-sub  
        Subtract                               
        JumpTrue     -compare-notequal-11-true 
        Jump         -compare-notequal-11-false 
        ...
        JumpTrue     -compare-boolAnd-13-true  
        Jump         -compare-boolAnd-13-false 
        Label        -compare-boolAnd-13-true  
        PushI        1                         
        ...
        Duplicate                              
        JumpFalse    -compare-boolAnd-15-false 
        Pop                                    
        ...
        JumpTrue     -compare-boolAnd-15-true  
        Jump         -compare-boolAnd-15-false 
        Label        -compare-boolAnd-15-true  
        PushI        1                         
        Jump         -compare-boolAnd-15-join  
        Label        -compare-boolAnd-15-false 
        PushI        0                         
        Jump         -compare-boolAnd-15-join  
        Label        -compare-boolAnd-15-join  
