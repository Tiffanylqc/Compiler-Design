        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-15-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-15-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-15-loop-start 
        Label        -clone-element-15-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-20-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-20-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-20-loop-start 
        Label        -clone-element-20-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Label        -compare-less-25-arg1     
        PushD        $global-memory-block      
        PushI        50                        
        Add                                    %% x
        LoadI                                  
        Label        -compare-less-25-arg2     
        PushD        $global-memory-block      
        PushI        38                        
        Add                                    %% width
        LoadI                                  
        Label        -compare-less-25-sub      
        Subtract                               
        ...
        JumpTrue     -while-42-true            
        Jump         -while-42-false           
        Label        -while-42-true            
        Label        -if-41-condition          
        ...
        Add                                    
        StoreI                                 
        Jump         -while-42-condition       
        Label        -while-42-false           
        Jump         -while-42-join            
        Label        -while-42-join            
        PushD        $global-memory-block      
        PushI        50                        
