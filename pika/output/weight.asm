        ...
        PushI        0                         
        Add                                    %% weight
        DLabel       -function-body-10-return-addr 
        DataZ        4                         
        Jump         -function-body-10--end    
        Label        -function-definition-1-weight-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        PushI        -16                       
        Add                                    %% g
        PushF        602000000000000000000000.000000 
        StoreF                                 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        -24                       
        ...
        Subtract                               
        LoadI                                  
        PushD        -function-body-10-return-addr 
        Exchange                               
        StoreI                                 
        PushD        $frame-pointer            
        LoadI                                  
        ...
        LoadI                                  
        Return                                 
        Label        -function-body-10--end    
        PushD        -function-definition-1-weight-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% hn
