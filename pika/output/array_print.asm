        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-26-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-26-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-26-loop-start 
        Label        -clone-element-26-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-28-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-28-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-28-loop-start 
        Label        -clone-element-28-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
