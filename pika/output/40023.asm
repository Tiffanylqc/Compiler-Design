        ...
        Label        -compare-equal-9-arg1     
        PushD        $global-memory-block      
        PushI        24                        
        Add                                    %% ri
        LoadI                                  
        Label        -compare-equal-9-arg2     
        PushI        1                         
        Label        -compare-equal-9-sub      
        Subtract                               
        JumpFalse    -compare-equal-9-true     
        Jump         -compare-equal-9-false    
        Label        -compare-equal-9-true     
        PushI        1                         
        Jump         -compare-equal-9-join     
        Label        -compare-equal-9-false    
        PushI        0                         
        Jump         -compare-equal-9-join     
        Label        -compare-equal-9-join     
        JumpTrue     -if-10-ifBody             
        Jump         -if-10-elseBody           
        Label        -if-10-ifBody             
        PushD        $global-memory-block      
        PushI        16                        
        ...
        Label        -compare-greaterequal-11-arg1 
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% fen5
        LoadI                                  
        Label        -compare-greaterequal-11-arg2 
        PushI        1                         
        Label        -compare-greaterequal-11-sub 
        Subtract                               
        ...
        Label        -compare-greaterequal-12-arg1 
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% fen2
        LoadI                                  
        Label        -compare-greaterequal-12-arg2 
        PushI        1                         
        Label        -compare-greaterequal-12-sub 
        Subtract                               
        ...
        Label        -compare-greaterequal-13-arg1 
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% fen1
        LoadI                                  
        Label        -compare-greaterequal-13-arg2 
        PushI        1                         
        Label        -compare-greaterequal-13-sub 
        Subtract                               
