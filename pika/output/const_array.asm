        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-10-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-10-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-10-loop-start 
        Label        -clone-element-10-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        $cloned-array-temp        
        Exchange                               
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-11-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-11-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-11-loop-start 
        Label        -clone-element-11-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        $cloned-array-temp        
        Exchange                               
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-12-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-12-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-12-loop-start 
        Label        -clone-element-12-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        $cloned-array-temp        
        Exchange                               
