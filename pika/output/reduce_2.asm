        ...
        Exchange                               
        StoreI                                 
        Label        -compare-notequal-12-arg1 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        0                         
        Add                                    %% x
        LoadI                                  
        Label        -compare-notequal-12-arg2 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        0                         
        Add                                    %% x
        ...
        PushI        2                         
        Multiply                               
        Label        -compare-notequal-12-sub  
        Subtract                               
        JumpTrue     -compare-notequal-12-true 
        Jump         -compare-notequal-12-false 
        Label        -compare-notequal-12-true 
        PushI        1                         
        Jump         -compare-notequal-12-join 
        Label        -compare-notequal-12-false 
        PushI        0                         
        Jump         -compare-notequal-12-join 
        Label        -compare-notequal-12-join 
        ...
        Add                                    %% isOdd
        LoadI                                  
        DLabel       -reduce-15-lambda-addr    
        DataZ        4                         
        DLabel       -reduce-15-array-addr     
        DataZ        4                         
        DLabel       -reduce-15-array-length-temp 
        DataZ        4                         
        DLabel       -reduce-15-record-creation-temp 
        DataZ        4                         
        DLabel       -reduce-15-array-element-temp 
        DataZ        4                         
        DLabel       -reduce-15-array-element-temp2 
        DataZ        4                         
        DLabel       -reduce-15-reduce-count   
        DataZ        4                         
        PushD        -reduce-15-lambda-addr    
        Exchange                               
        StoreI                                 
        Duplicate                              
        JumpFalse    $$null-array              
        PushD        -reduce-15-array-addr     
        Exchange                               
        StoreI                                 
        PushD        -reduce-15-array-addr     
        LoadI                                  
        ...
        Add                                    
        LoadI                                  
        PushD        -reduce-15-array-length-temp 
        Exchange                               
        StoreI                                 
        PushI        0                         
        PushD        -reduce-15-reduce-count   
        Exchange                               
        StoreI                                 
        PushD        -reduce-15-array-addr     
        LoadI                                  
        PushI        16                        
        Add                                    
        PushD        -reduce-15-array-element-temp 
        Exchange                               
        StoreI                                 
        Label        -reduce-15-loop-start     
        PushD        -reduce-15-array-length-temp 
        LoadI                                  
        JumpFalse    -reduce-15-exit           
        PushD        -reduce-15-array-element-temp 
        LoadI                                  
        LoadI                                  
        PushI        -4                        
        ...
        Exchange                               
        StoreI                                 
        Jump         -reduce-15-loop-start     
        Label        -reduce-15-exit           
        PushD        -reduce-15-reduce-count   
        LoadI                                  
        Duplicate                              
        ...
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        -reduce-15-record-creation-temp 
        Exchange                               
        StoreI                                 
        PushD        -reduce-15-record-creation-temp 
        LoadI                                  
        ...
        Multiply                               
        Add                                    
        PushD        -reduce-15-array-element-temp2 
        Exchange                               
        StoreI                                 
        Label        -reduce-15-loop-start2    
        PushD        -reduce-15-reduce-count   
        LoadI                                  
        JumpFalse    -reduce-15-exit-2         
        PushD        -reduce-15-array-element-temp2 
        LoadI                                  
        Exchange                               
        StoreI                                 
        ...
        Exchange                               
        StoreI                                 
        Jump         -reduce-15-loop-start2    
        Label        -reduce-15-exit-2         
        PushD        -reduce-15-record-creation-temp 
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Label        -function-body-20--anonymous-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        JumpTrue     -if-19-ifBody             
        Jump         -if-19-elseBody           
        Label        -if-19-ifBody             
        PushI        1                         
        Jump         -function-body-16--exit-handshake 
        Jump         -if-19-join               
        Label        -if-19-elseBody           
        PushI        0                         
        Jump         -function-body-16--exit-handshake 
        Label        -if-19-join               
        Jump         $$no return               
        ...
        PushD        -function-body-20--anonymous-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% rats
        ...
        Add                                    %% isPositive
        LoadI                                  
        DLabel       -reduce-27-lambda-addr    
        DataZ        4                         
        DLabel       -reduce-27-array-addr     
        DataZ        4                         
        DLabel       -reduce-27-array-length-temp 
        DataZ        4                         
        DLabel       -reduce-27-record-creation-temp 
        DataZ        4                         
        DLabel       -reduce-27-array-element-temp 
        DataZ        4                         
        DLabel       -reduce-27-array-element-temp2 
        DataZ        4                         
        DLabel       -reduce-27-reduce-count   
        DataZ        4                         
        PushD        -reduce-27-lambda-addr    
        Exchange                               
        StoreI                                 
        Duplicate                              
        JumpFalse    $$null-array              
        PushD        -reduce-27-array-addr     
        Exchange                               
        StoreI                                 
        PushD        -reduce-27-array-addr     
        LoadI                                  
        ...
        Add                                    
        LoadI                                  
        PushD        -reduce-27-array-length-temp 
        Exchange                               
        StoreI                                 
        PushI        0                         
        PushD        -reduce-27-reduce-count   
        Exchange                               
        StoreI                                 
        PushD        -reduce-27-array-addr     
        LoadI                                  
        PushI        16                        
        Add                                    
        PushD        -reduce-27-array-element-temp 
        Exchange                               
        StoreI                                 
        Label        -reduce-27-loop-start     
        PushD        -reduce-27-array-length-temp 
        LoadI                                  
        JumpFalse    -reduce-27-exit           
        PushD        -reduce-27-array-element-temp 
        LoadI                                  
        LoadI                                  
        PushD        -reduce-27-array-element-temp 
        ...
        Exchange                               
        StoreI                                 
        Jump         -reduce-27-loop-start     
        Label        -reduce-27-exit           
        PushD        -reduce-27-reduce-count   
        LoadI                                  
        Duplicate                              
        JumpNeg      $$negative-length-array   
        ...
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        -reduce-27-record-creation-temp 
        Exchange                               
        StoreI                                 
        PushD        -reduce-27-record-creation-temp 
        LoadI                                  
        ...
        Multiply                               
        Add                                    
        PushD        -reduce-27-array-element-temp2 
        Exchange                               
        StoreI                                 
        Label        -reduce-27-loop-start2    
        PushD        -reduce-27-reduce-count   
        LoadI                                  
        JumpFalse    -reduce-27-exit-2         
        PushD        -reduce-27-array-element-temp2 
        LoadI                                  
        PushI        4                         
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -reduce-27-loop-start2    
        Label        -reduce-27-exit-2         
        PushD        -reduce-27-record-creation-temp 
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Add                                    %% isOdd
        LoadI                                  
        DLabel       -reduce-28-lambda-addr    
        DataZ        4                         
        DLabel       -reduce-28-array-addr     
        DataZ        4                         
        DLabel       -reduce-28-array-length-temp 
        DataZ        4                         
        DLabel       -reduce-28-record-creation-temp 
        DataZ        4                         
        DLabel       -reduce-28-array-element-temp 
        DataZ        4                         
        DLabel       -reduce-28-array-element-temp2 
        DataZ        4                         
        DLabel       -reduce-28-reduce-count   
        DataZ        4                         
        PushD        -reduce-28-lambda-addr    
        Exchange                               
        StoreI                                 
        Duplicate                              
        JumpFalse    $$null-array              
        PushD        -reduce-28-array-addr     
        Exchange                               
        StoreI                                 
        PushD        -reduce-28-array-addr     
        LoadI                                  
        ...
        Add                                    
        LoadI                                  
        PushD        -reduce-28-array-length-temp 
        Exchange                               
        StoreI                                 
        PushI        0                         
        PushD        -reduce-28-reduce-count   
        Exchange                               
        StoreI                                 
        PushD        -reduce-28-array-addr     
        LoadI                                  
        PushI        16                        
        Add                                    
        PushD        -reduce-28-array-element-temp 
        Exchange                               
        StoreI                                 
        Label        -reduce-28-loop-start     
        PushD        -reduce-28-array-length-temp 
        LoadI                                  
        JumpFalse    -reduce-28-exit           
        PushD        -reduce-28-array-element-temp 
        LoadI                                  
        LoadI                                  
        PushI        -4                        
        ...
        Exchange                               
        StoreI                                 
        Jump         -reduce-28-loop-start     
        Label        -reduce-28-exit           
        PushD        -reduce-28-reduce-count   
        LoadI                                  
        Duplicate                              
        JumpNeg      $$negative-length-array   
        ...
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        -reduce-28-record-creation-temp 
        Exchange                               
        StoreI                                 
        PushD        -reduce-28-record-creation-temp 
        LoadI                                  
        ...
        Multiply                               
        Add                                    
        PushD        -reduce-28-array-element-temp2 
        Exchange                               
        StoreI                                 
        Label        -reduce-28-loop-start2    
        PushD        -reduce-28-reduce-count   
        LoadI                                  
        JumpFalse    -reduce-28-exit-2         
        PushD        -reduce-28-array-element-temp2 
        LoadI                                  
        Exchange                               
        StoreI                                 
        ...
        Exchange                               
        StoreI                                 
        Jump         -reduce-28-loop-start2    
        Label        -reduce-28-exit-2         
        PushD        -reduce-28-record-creation-temp 
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        PushI        28                        
        Add                                    %% isOddLength
        DLabel       -function-body-31-return-addr 
        DataZ        4                         
        Jump         -function-body-31--end    
        Label        -function-body-31--anonymous-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -function-body-30--exit-handshake 
        Jump         $$no return               
        Label        -function-body-30--exit-handshake 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        8                         
        Subtract                               
        LoadI                                  
        PushD        -function-body-31-return-addr 
        Exchange                               
        StoreI                                 
        PushD        $frame-pointer            
        LoadI                                  
        ...
        LoadI                                  
        Return                                 
        Label        -function-body-31--end    
        PushD        -function-body-31--anonymous-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        32                        
        Add                                    %% oddLenStrs
        ...
        Add                                    %% isOddLength
        LoadI                                  
        DLabel       -reduce-32-lambda-addr    
        DataZ        4                         
        DLabel       -reduce-32-array-addr     
        DataZ        4                         
        DLabel       -reduce-32-array-length-temp 
        DataZ        4                         
        DLabel       -reduce-32-record-creation-temp 
        DataZ        4                         
        DLabel       -reduce-32-array-element-temp 
        DataZ        4                         
        DLabel       -reduce-32-array-element-temp2 
        DataZ        4                         
        DLabel       -reduce-32-reduce-count   
        DataZ        4                         
        PushD        -reduce-32-lambda-addr    
        Exchange                               
        StoreI                                 
        Duplicate                              
        JumpFalse    $$null-array              
        PushD        -reduce-32-array-addr     
        Exchange                               
        StoreI                                 
        PushD        -reduce-32-array-addr     
        LoadI                                  
        ...
        Add                                    
        LoadI                                  
        PushD        -reduce-32-array-length-temp 
        Exchange                               
        StoreI                                 
        PushI        0                         
        PushD        -reduce-32-reduce-count   
        Exchange                               
        StoreI                                 
        PushD        -reduce-32-array-addr     
        LoadI                                  
        PushI        16                        
        Add                                    
        PushD        -reduce-32-array-element-temp 
        Exchange                               
        StoreI                                 
        Label        -reduce-32-loop-start     
        PushD        -reduce-32-array-length-temp 
        LoadI                                  
        JumpFalse    -reduce-32-exit           
        PushD        -reduce-32-array-element-temp 
        LoadI                                  
        LoadI                                  
        PushI        -4                        
        ...
        Exchange                               
        StoreI                                 
        Jump         -reduce-32-loop-start     
        Label        -reduce-32-exit           
        PushD        -reduce-32-reduce-count   
        LoadI                                  
        Duplicate                              
        JumpNeg      $$negative-length-array   
        ...
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        -reduce-32-record-creation-temp 
        Exchange                               
        StoreI                                 
        PushD        -reduce-32-record-creation-temp 
        LoadI                                  
        ...
        Multiply                               
        Add                                    
        PushD        -reduce-32-array-element-temp2 
        Exchange                               
        StoreI                                 
        Label        -reduce-32-loop-start2    
        PushD        -reduce-32-reduce-count   
        LoadI                                  
        JumpFalse    -reduce-32-exit-2         
        PushD        -reduce-32-array-element-temp2 
        LoadI                                  
        Exchange                               
        StoreI                                 
        ...
        Exchange                               
        StoreI                                 
        Jump         -reduce-32-loop-start2    
        Label        -reduce-32-exit-2         
        PushD        -reduce-32-record-creation-temp 
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
