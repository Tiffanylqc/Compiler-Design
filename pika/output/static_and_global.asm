        ...
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% how_many_time_this_is_called
        ...
        LoadI                                  
        CallV                                  
        DLabel       -for-index-23-for-length  
        DataZ        4                         
        DLabel       -for-index-23-for-index   
        DataZ        4                         
        DLabel       -for-index-23-for-expr    
        DataZ        4                         
        DLabel       -for-index-23-for-subsize 
        DataZ        4                         
        DLabel       -for-index-23-for-indentifier 
        DataZ        4                         
        PushI        20                        
        Duplicate                              
        ...
        JumpFalse    $$null-array              
        Duplicate                              
        PushD        -for-index-23-for-expr    
        Exchange                               
        StoreI                                 
        PushI        12                        
        Add                                    
        LoadI                                  
        PushD        -for-index-23-for-length  
        Exchange                               
        StoreI                                 
        PushI        0                         
        PushD        -for-index-23-for-index   
        Exchange                               
        StoreI                                 
        Label        -for-index-23-loop-start  
        PushD        -for-index-23-for-length  
        LoadI                                  
        PushD        -for-index-23-for-index   
        LoadI                                  
        Subtract                               
        JumpPos      -for-index-23-in-label    
        Jump         -for-index-23-exit        
        Label        -for-index-23-in-label    
        PushD        $global-memory-block      
        PushI        32                        
        Add                                    %% i
        PushD        -for-index-23-for-index   
        ...
        Exchange                               
        StoreI                                 
        Jump         -for-index-23-loop-start  
        Label        -for-index-enter-22-break-target 
        Jump         -for-index-23-exit        
        Label        -for-index-enter-22-continue-target 
        PushI        1                         
        PushD        -for-index-23-for-index   
        LoadI                                  
        Add                                    
