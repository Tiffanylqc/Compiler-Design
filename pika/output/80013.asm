        ...
        Label        -compare-less-26-arg1     
        PushD        $global-memory-block      
        PushI        28                        
        Add                                    %% k
        LoadI                                  
        Label        -compare-less-26-arg2     
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% n
        LoadI                                  
        Label        -compare-less-26-sub      
        Subtract                               
        ...
        Add                                    
        StoreI                                 
        Jump         -while-40-condition       
        Label        -while-40-false           
        Jump         -while-40-join            
        Label        -while-40-join            
        Halt                                   
