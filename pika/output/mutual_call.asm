        ...
        PushI        0                         
        Add                                    %% foo
        DLabel       -function-body-11-return-addr 
        DataZ        4                         
        Jump         -function-body-11--end    
        Label        -function-definition-1-foo-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        Subtract                               
        LoadI                                  
        PushD        -function-body-11-return-addr 
        Exchange                               
        StoreI                                 
        PushD        $frame-pointer            
        LoadI                                  
        ...
        LoadI                                  
        Return                                 
        Label        -function-body-11--end    
        PushD        -function-definition-1-foo-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% bar
        ...
        Label        -function-definition-2-bar-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        PushD        -function-definition-2-bar-start 
        StoreI                                 
        PushI        3                         
        PushI        -4                        
        PushD        $stack-pointer            
