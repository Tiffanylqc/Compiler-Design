        ...
        PushI        2                         
        Duplicate                              
        JumpFalse    $$rational-divide-by-zero 
        ...
        StoreI                                 
        Duplicate                              
        JumpPos      -print-rational-12-denominator-pos 
        PushD        $rational-print-sign      
        LoadI                                  
        Negate                                 
        PushD        $rational-print-sign      
        ...
        StoreI                                 
        Negate                                 
        Label        -print-rational-12-denominator-pos 
        PushD        $rational-denominator-temp 
        Exchange                               
        StoreI                                 
        Duplicate                              
        Duplicate                              
        JumpFalse    -print-rational-12-zero-numerator 
        JumpPos      -print-rational-12-numerator-pos 
        PushD        $rational-print-sign      
        LoadI                                  
        Negate                                 
        PushD        $rational-print-sign      
        ...
        StoreI                                 
        Negate                                 
        Label        -print-rational-12-numerator-pos 
        PushD        $rational-numerator-temp  
        Exchange                               
        StoreI                                 
        PushD        $rational-numerator-temp  
        ...
        PushD        $rational-print-sign      
        LoadI                                  
        JumpPos      -print-rational-12-rational-pos 
        PushD        $minus-sign-string        
        PushD        $print-format-string      
        Printf                                 
        Label        -print-rational-12-rational-pos 
        JumpFalse    -print-rational-12-fraction 
        PushD        $rational-print-integer-part 
        LoadI                                  
        PushD        $print-format-integer     
        Printf                                 
        Label        -print-rational-12-fraction 
        ...
        Label        -print-rational-12-zero-numerator 
        PushD        $print-format-integer     
        Printf                                 
        Pop                                    
