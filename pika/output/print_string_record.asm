        ...
        Exchange                               
        StoreI                                 
        Label        -print-string-3-loop-start 
        PushD        $print-string-length      
        LoadI                                  
        JumpFalse    -print-string-3-end       
        PushD        $print-string-temp        
        LoadI                                  
        LoadC                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -print-string-3-loop-start 
        ...
        Label        -compare-equal-4-arg1     
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% a
        LoadI                                  
        Label        -compare-equal-4-arg2     
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% b
        LoadI                                  
        Label        -compare-equal-4-sub      
        Subtract                               
        JumpFalse    -compare-equal-4-true     
        Jump         -compare-equal-4-false    
        Label        -compare-equal-4-true     
        PushI        1                         
        Jump         -compare-equal-4-join     
        Label        -compare-equal-4-false    
        PushI        0                         
        Jump         -compare-equal-4-join     
        Label        -compare-equal-4-join     
        JumpTrue     -if-7-ifBody              
        Jump         -if-7-elseBody            
        Label        -if-7-ifBody              
        PushI        4                         
        PushI        1                         
