        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -lowest-term-subroutine-6-exchange 
        PushD        $lowest-term-numerator    
        LoadI                                  
        PushD        $lowest-term-denominator  
        LoadI                                  
        Jump         -lowest-term-subroutine-6-loop-start 
        Label        -lowest-term-subroutine-6-exchange 
        PushD        $lowest-term-denominator  
        LoadI                                  
        PushD        $lowest-term-numerator    
        LoadI                                  
        Label        -lowest-term-subroutine-6-loop-start 
        ...
        LoadI                                  
        Duplicate                              
        JumpFalse    -lowest-term-subroutine-6-end 
        Remainder                              
        PushD        $lowest-term-tmpb         
        LoadI                                  
        Exchange                               
        Jump         -lowest-term-subroutine-6-loop-start 
        Label        -lowest-term-subroutine-6-end 
        Pop                                    
        ...
        Exchange                               
        StoreI                                 
        Label        -clear-n-bytes-subroutine-7-loop-start 
        PushD        $clear-n-bytes-element-size 
        LoadI                                  
        JumpFalse    -clear-n-bytes-subroutine-7-end 
        PushI        0                         
        PushD        $clear-n-bytes-element-addr 
        Exchange                               
        StoreC                                 
        ...
        Exchange                               
        StoreI                                 
        Jump         -clear-n-bytes-subroutine-7-loop-start 
        Label        -clear-n-bytes-subroutine-7-end 
        PushD        $clear-n-bytes-return-address 
        LoadI                                  
        Return                                 
        Label        $print-array-subroutine   
        DLabel       -print-array-recursive-8-return-address 
        DataZ        4                         
        PushD        -print-array-recursive-8-return-address 
        Exchange                               
        StoreI                                 
        DLabel       -print-array-recursive-8-type 
        DataZ        4                         
        PushD        -print-array-recursive-8-type 
        Exchange                               
        StoreI                                 
        DLabel       -print-array-recursive-8-element 
        DataZ        4                         
        DLabel       -print-array-recursive-8-length 
        DataZ        4                         
        DLabel       -print-array-recursive-8-elem-size 
        DataZ        4                         
        Duplicate                              
        ...
        PushI        16                        
        Add                                    
        PushD        -print-array-recursive-8-element 
        Exchange                               
        StoreI                                 
        PushI        12                        
        Add                                    
        LoadI                                  
        PushD        -print-array-recursive-8-length 
        Exchange                               
        StoreI                                 
        PushI        8                         
        Add                                    
        LoadI                                  
        PushD        -print-array-recursive-8-elem-size 
        Exchange                               
        StoreI                                 
        ...
        PushI        2                         
        BTAnd                                  
        JumpFalse    -print-array-recursive-8-one-dim 
        Label        -print-array-recursive-8-loop-start 
        PushD        -print-array-recursive-8-length 
        LoadI                                  
        JumpFalse    -print-array-recursive-8-end 
        PushD        -print-array-recursive-8-return-address 
        LoadI                                  
        PushD        -print-array-recursive-8-type 
        LoadI                                  
        ...
        PushI        0                         
        Subtract                               
        JumpFalse    -print-array-recursive-8-loop-start 
        PushD        $comma-string             
        PushD        $print-format-string      
        Printf                                 
        ...
        PushD        $print-format-string      
        Printf                                 
        Jump         -print-array-recursive-8-loop-start 
        Label        -print-array-recursive-8-one-dim 
        Label        -print-array-recursive-8-loop-start-2 
        PushD        -print-array-recursive-8-length 
        LoadI                                  
        JumpFalse    -print-array-recursive-8-end 
        PushD        -print-array-recursive-8-element 
        ...
        PushI        1                         
        Subtract                               
        JumpFalse    -print-array-recursive-8-int-label 
        PushD        -print-array-recursive-8-type 
        LoadI                                  
        PushI        2                         
        Subtract                               
        JumpFalse    -print-array-recursive-8-float-label 
        PushD        -print-array-recursive-8-type 
        LoadI                                  
        PushI        3                         
        Subtract                               
        JumpFalse    -print-array-recursive-8-char-label 
        PushD        -print-array-recursive-8-type 
        LoadI                                  
        PushI        4                         
        Subtract                               
        JumpFalse    -print-array-recursive-8-string-label 
        PushD        -print-array-recursive-8-type 
        LoadI                                  
        PushI        5                         
        Subtract                               
        JumpFalse    -print-array-recursive-8-rat-label 
        PushD        -print-array-recursive-8-type 
        LoadI                                  
        PushI        6                         
        Subtract                               
        JumpFalse    -print-array-recursive-8-bool-label 
        Label        -print-array-recursive-8-int-label 
        LoadI                                  
        PushD        $print-format-integer     
        Printf                                 
        Jump         -print-array-recursive-8-join-label 
        Label        -print-array-recursive-8-float-label 
        LoadF                                  
        PushD        $print-format-floating    
        Printf                                 
        Jump         -print-array-recursive-8-join-label 
        Label        -print-array-recursive-8-char-label 
        LoadC                                  
        PushD        $print-format-character   
        Printf                                 
        Jump         -print-array-recursive-8-join-label 
        Label        -print-array-recursive-8-rat-label 
        Duplicate                              
        LoadI                                  
        Exchange                               
        PushI        4                         
        ...
        Call         $print-rational           
        Jump         -print-array-recursive-8-join-label 
        Label        -print-array-recursive-8-bool-label 
        LoadC                                  
        Call         $convert-to-string-if-bool-subroutine 
        PushD        $print-format-boolean     
        Printf                                 
        Jump         -print-array-recursive-8-join-label 
        Label        -print-array-recursive-8-string-label 
        LoadI                                  
        Call         $print-string             
        Jump         -print-array-recursive-8-join-label 
        Label        -print-array-recursive-8-join-label 
        PushD        -print-array-recursive-8-elem-size 
        LoadI                                  
        PushD        -print-array-recursive-8-element 
        LoadI                                  
        ...
        PushI        0                         
        Subtract                               
        JumpFalse    -print-array-recursive-8-loop-start-2 
        PushD        $comma-string             
        PushD        $print-format-string      
        Printf                                 
        PushD        $print-format-space       
        PushD        $print-format-string      
        Printf                                 
        Jump         -print-array-recursive-8-loop-start-2 
        Label        -print-array-recursive-8-end 
        ...
        JumpFalse    $$over-zero-denominator   
        Duplicate                              
        JumpPos      -print-rational-9-denominator-pos 
        PushD        $rational-print-sign      
        LoadI                                  
        Negate                                 
        PushD        $rational-print-sign      
        ...
        StoreI                                 
        Negate                                 
        Label        -print-rational-9-denominator-pos 
        PushD        $rational-denominator-temp 
        Exchange                               
        StoreI                                 
        Duplicate                              
        Duplicate                              
        JumpFalse    -print-rational-9-zero-numerator 
        JumpPos      -print-rational-9-numerator-pos 
        PushD        $rational-print-sign      
        LoadI                                  
        Negate                                 
        PushD        $rational-print-sign      
        ...
        StoreI                                 
        Negate                                 
        Label        -print-rational-9-numerator-pos 
        ...
        PushD        $rational-print-sign      
        LoadI                                  
        JumpPos      -print-rational-9-rational-pos 
        PushD        $minus-sign-string        
        PushD        $print-format-string      
        Printf                                 
        Label        -print-rational-9-rational-pos 
        JumpFalse    -print-rational-9-fraction 
        PushD        $rational-print-integer-part 
        LoadI                                  
        PushD        $print-format-integer     
        Printf                                 
        Label        -print-rational-9-fraction 
        JumpFalse    -print-rational-9-end     
        PushD        $dash-string              
        PushD        $print-format-string      
        Printf                                 
        PushD        $rational-print-remainder 
        ...
        PushD        $print-format-integer     
        Printf                                 
        Jump         -print-rational-9-end     
        Label        -print-rational-9-zero-numerator 
        PushD        $print-format-integer     
        Printf                                 
        Pop                                    
        Label        -print-rational-9-end     
        PushD        $print-rational-return-address 
        LoadI                                  
        Return                                 
        Label        $print-string             
        ...
        Exchange                               
        StoreI                                 
        Label        -print-string-10-loop-start 
        PushD        $print-string-length      
        LoadI                                  
        JumpFalse    -print-string-10-end      
        PushD        $print-string-temp        
        LoadI                                  
        LoadC                                  
        PushD        $print-format-character   
        ...
        Exchange                               
        StoreI                                 
        Jump         -print-string-10-loop-start 
        Label        -print-string-10-end      
        PushD        $print-string-return-address 
        LoadI                                  
        Return                                 
        ...
        LoadI                                  
        Return                                 
        DLabel       -release-record-12-length 
        DataZ        4                         
        DLabel       -release-record-12-element-size 
        DataZ        4                         
        DLabel       -release-record-12-element 
        DataZ        4                         
        ...
        PushI        4                         
        BTAnd                                  
        JumpTrue     -release-record-12-end    
        PushI        8                         
        BTAnd                                  
        JumpTrue     -release-record-12-end    
        PushI        2                         
        BTAnd                                  
        JumpFalse    -release-record-12-release 
        Duplicate                              
        Duplicate                              
        PushI        12                        
        Add                                    
        LoadI                                  
        PushD        -release-record-12-length 
        Exchange                               
        StoreI                                 
        PushI        8                         
        Add                                    
        LoadI                                  
        PushD        -release-record-12-element-size 
        Exchange                               
        StoreI                                 
        PushI        16                        
        Add                                    
        PushD        -release-record-12-element 
        Exchange                               
        StoreI                                 
        Jump         -release-record-12-join   
        Label        -release-record-12-string-record 
        Duplicate                              
        PushI        8                         
        Add                                    
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Label        -release-record-12-join   
        Label        -release-record-12-loop-start 
        PushD        -release-record-12-length 
        LoadI                                  
        JumpFalse    -release-record-12-end    
        PushD        -release-record-12-element 
        LoadI                                  
        PushD        -release-record-12-length 
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -release-record-12-loop-start 
        Label        -release-record-12-release 
        Duplicate                              
        Duplicate                              
        PushI        4                         
        Add                                    
        ...
        Label        -function-definition-2-f2-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        PushD        -function-definition-2-f2-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% f3
        ...
        Label        -function-definition-3-f3-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        PushD        -function-definition-3-f3-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% f4
        DLabel       -function-body-20-return-addr 
        DataZ        4                         
        Jump         -function-body-20--end    
        Label        -function-definition-4-f4-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        Subtract                               
        LoadI                                  
        PushD        -function-body-20-return-addr 
        Exchange                               
        StoreI                                 
        PushD        $frame-pointer            
        LoadI                                  
        ...
        LoadI                                  
        Return                                 
        Label        -function-body-20--end    
        PushD        -function-definition-4-f4-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% f5
        DLabel       -function-body-22-return-addr 
        DataZ        4                         
        Jump         -function-body-22--end    
        Label        -function-definition-5-f5-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        PushD        $record-creation-temp     
        LoadI                                  
        Jump         -function-body-21--exit-handshake 
        Jump         $$no return               
        Label        -function-body-21--exit-handshake 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        8                         
        Subtract                               
        LoadI                                  
        PushD        -function-body-22-return-addr 
        Exchange                               
        StoreI                                 
        PushD        $frame-pointer            
        LoadI                                  
        ...
        LoadI                                  
        Return                                 
        Label        -function-body-22--end    
        PushD        -function-definition-5-f5-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        20                        
        Add                                    %% a1
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-25-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-25-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-30-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-30-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-31-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-31-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-32-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-32-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-34-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-34-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-36-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-36-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-37-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-37-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-38-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-38-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-38-loop-start 
        Label        -clone-element-38-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-42-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-42-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-43-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-43-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-44-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-44-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-47-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-47-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-47-loop-start 
        Label        -clone-element-47-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
