        ...
        Label        -compare-boolAnd-3-arg1   
        PushI        0                         
        Duplicate                              
        JumpFalse    -compare-boolAnd-3-false  
        Pop                                    
        Label        -compare-equal-2-arg1     
        PushI        3                         
        PushI        0                         
        Duplicate                              
        JumpFalse    $$i-divide-by-zero        
        Divide                                 
        Label        -compare-equal-2-arg2     
        PushI        1                         
        Label        -compare-equal-2-sub      
        Subtract                               
        JumpFalse    -compare-equal-2-true     
        Jump         -compare-equal-2-false    
        Label        -compare-equal-2-true     
        PushI        1                         
        Jump         -compare-equal-2-join     
        Label        -compare-equal-2-false    
        PushI        0                         
        Jump         -compare-equal-2-join     
        Label        -compare-equal-2-join     
        JumpTrue     -compare-boolAnd-3-true   
        Jump         -compare-boolAnd-3-false  
        Label        -compare-boolAnd-3-true   
        PushI        1                         
        Jump         -compare-boolAnd-3-join   
        Label        -compare-boolAnd-3-false  
        PushI        0                         
        Jump         -compare-boolAnd-3-join   
        Label        -compare-boolAnd-3-join   
        JumpTrue     -if-6-ifBody              
        Jump         -if-6-elseBody            
        Label        -if-6-ifBody              
        PushI        1                         
