        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-33-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-33-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-33-loop-start 
        Label        -clone-element-33-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-34-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-34-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-34-loop-start 
        Label        -clone-element-34-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-35-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-35-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-35-loop-start 
        Label        -clone-element-35-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-36-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-36-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-36-loop-start 
        Label        -clone-element-36-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-37-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-37-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-37-loop-start 
        Label        -clone-element-37-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-39-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-39-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-39-loop-start 
        Label        -clone-element-39-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-40-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-40-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-40-loop-start 
        Label        -clone-element-40-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-41-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-41-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-41-loop-start 
        Label        -clone-element-41-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        Exchange                               
        StoreI                                 
        Label        -clone-element-42-loop-start 
        PushD        $array-datasize-temp      
        LoadI                                  
        PushD        $array-element-temp       
        LoadI                                  
        Subtract                               
        JumpFalse    -clone-element-42-end     
        PushD        $record-creation-temp     
        LoadI                                  
        PushI        16                        
        Add                                    
        ...
        Exchange                               
        StoreI                                 
        Jump         -clone-element-42-loop-start 
        Label        -clone-element-42-end     
        PushD        $record-creation-temp     
        LoadI                                  
        StoreI                                 
        PushD        $global-memory-block      
        ...
        PushD        $print-format-space       
        Printf                                 
        Label        -compare-equal-44-arg1    
        PushD        $global-memory-block      
        PushI        44                        
        Add                                    %% g
        LoadI                                  
        Label        -compare-equal-44-arg2    
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% b
        LoadI                                  
        Label        -compare-equal-44-sub     
        Subtract                               
        JumpFalse    -compare-equal-44-true    
        Jump         -compare-equal-44-false   
        Label        -compare-equal-44-true    
        PushI        1                         
        Jump         -compare-equal-44-join    
        Label        -compare-equal-44-false   
        PushI        0                         
        Jump         -compare-equal-44-join    
        Label        -compare-equal-44-join    
        Call         $convert-to-string-if-bool-subroutine 
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-space       
        Printf                                 
        Label        -compare-equal-45-arg1    
        PushD        $global-memory-block      
        PushI        48                        
        Add                                    %% h
        LoadI                                  
        Label        -compare-equal-45-arg2    
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% c
        LoadI                                  
        Label        -compare-equal-45-sub     
        Subtract                               
        JumpFalse    -compare-equal-45-true    
        Jump         -compare-equal-45-false   
        Label        -compare-equal-45-true    
        PushI        1                         
        Jump         -compare-equal-45-join    
        Label        -compare-equal-45-false   
        PushI        0                         
        Jump         -compare-equal-45-join    
        Label        -compare-equal-45-join    
        Call         $convert-to-string-if-bool-subroutine 
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-space       
        ...
        PushD        $print-format-space       
        Printf                                 
        Label        -compare-equal-47-arg1    
        PushD        $global-memory-block      
        PushI        56                        
        Add                                    %% j
        LoadI                                  
        Label        -compare-equal-47-arg2    
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% e
        LoadI                                  
        Label        -compare-equal-47-sub     
        Subtract                               
        JumpFalse    -compare-equal-47-true    
        Jump         -compare-equal-47-false   
        Label        -compare-equal-47-true    
        PushI        1                         
        Jump         -compare-equal-47-join    
        Label        -compare-equal-47-false   
        PushI        0                         
        Jump         -compare-equal-47-join    
        Label        -compare-equal-47-join    
        Call         $convert-to-string-if-bool-subroutine 
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-space       
        ...
        PushD        $print-format-space       
        Printf                                 
        Label        -compare-equal-49-arg1    
        PushD        $global-memory-block      
        PushI        64                        
        Add                                    %% gg
        LoadI                                  
        Label        -compare-equal-49-arg2    
        PushD        $global-memory-block      
        PushI        24                        
        Add                                    %% bb
        LoadI                                  
        Label        -compare-equal-49-sub     
        Subtract                               
        JumpFalse    -compare-equal-49-true    
        Jump         -compare-equal-49-false   
        Label        -compare-equal-49-true    
        PushI        1                         
        Jump         -compare-equal-49-join    
        Label        -compare-equal-49-false   
        PushI        0                         
        Jump         -compare-equal-49-join    
        Label        -compare-equal-49-join    
        Call         $convert-to-string-if-bool-subroutine 
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-space       
        ...
        Subtract                               
        JumpFalse    -compare-equal-50-true    
        ...
        PushD        $print-format-space       
        Printf                                 
        Label        -compare-equal-51-arg1    
        PushD        $global-memory-block      
        PushI        72                        
        Add                                    %% ii
        LoadI                                  
        Label        -compare-equal-51-arg2    
        PushD        $global-memory-block      
        PushI        32                        
        Add                                    %% dd
        LoadI                                  
        Label        -compare-equal-51-sub     
        Subtract                               
        JumpFalse    -compare-equal-51-true    
        Jump         -compare-equal-51-false   
        Label        -compare-equal-51-true    
        PushI        1                         
        Jump         -compare-equal-51-join    
        Label        -compare-equal-51-false   
        PushI        0                         
        Jump         -compare-equal-51-join    
        Label        -compare-equal-51-join    
        Call         $convert-to-string-if-bool-subroutine 
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-space       
        Printf                                 
        Label        -compare-equal-52-arg1    
        PushD        $global-memory-block      
        PushI        76                        
        Add                                    %% jj
        LoadI                                  
        Label        -compare-equal-52-arg2    
        PushD        $global-memory-block      
        PushI        36                        
        Add                                    %% ee
        LoadI                                  
        Label        -compare-equal-52-sub     
        Subtract                               
        JumpFalse    -compare-equal-52-true    
        Jump         -compare-equal-52-false   
        Label        -compare-equal-52-true    
        PushI        1                         
        Jump         -compare-equal-52-join    
        Label        -compare-equal-52-false   
        PushI        0                         
        Jump         -compare-equal-52-join    
        Label        -compare-equal-52-join    
        Call         $convert-to-string-if-bool-subroutine 
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-space       
        ...
        PushD        $print-format-space       
        Printf                                 
        Label        -compare-notequal-54-arg1 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% a
        LoadI                                  
        Label        -compare-notequal-54-arg2 
        PushD        $global-memory-block      
        PushI        0                         
        Add                                    %% a
        LoadI                                  
        Label        -compare-notequal-54-sub  
        Subtract                               
        JumpTrue     -compare-notequal-54-true 
        Jump         -compare-notequal-54-false 
        Label        -compare-notequal-54-true 
        PushI        1                         
        Jump         -compare-notequal-54-join 
        Label        -compare-notequal-54-false 
        PushI        0                         
        Jump         -compare-notequal-54-join 
        Label        -compare-notequal-54-join 
        Call         $convert-to-string-if-bool-subroutine 
        PushD        $print-format-boolean     
        Printf                                 
        Halt                                   
