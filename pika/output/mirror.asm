        ...
        Label        -compare-lessequal-11-arg1 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        -16                       
        Add                                    %% i
        LoadI                                  
        Label        -compare-lessequal-11-arg2 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        -12                       
        Add                                    %% n
        ...
        Divide                                 
        Label        -compare-lessequal-11-sub 
        Subtract                               
        ...
        Label        -compare-notequal-14-arg1 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        0                         
        Add                                    %% p
        ...
        Add                                    
        LoadC                                  
        Label        -compare-notequal-14-arg2 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        0                         
        Add                                    %% p
        ...
        Add                                    
        LoadC                                  
        Label        -compare-notequal-14-sub  
        Subtract                               
        JumpTrue     -compare-notequal-14-true 
        Jump         -compare-notequal-14-false 
        Label        -compare-notequal-14-true 
        PushI        1                         
        Jump         -compare-notequal-14-join 
        Label        -compare-notequal-14-false 
        PushI        0                         
        Jump         -compare-notequal-14-join 
        Label        -compare-notequal-14-join 
