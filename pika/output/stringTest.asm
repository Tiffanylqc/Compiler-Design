        ...
        Label        -while-enter-8-continue-target 
        ...
        Label        -while-enter-8-break-target 
        Jump         -while-11-join            
        Label        -while-11-join            
        ...
        PushI        0                         
        PushI        3                         
        PushD        $slice-string-index2      
        Exchange                               
        StoreI                                 
        PushD        $slice-string-index1      
        Exchange                               
        StoreI                                 
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      $$string-slice-index-error 
        PushD        $slice-string-index2      
        LoadI                                  
        PushD        $slice-string-index1      
        LoadI                                  
        Subtract                               
        JumpPos      -string-slice-19-in-bounds 
        Jump         $$string-slice-index-error 
        Label        -string-slice-19-in-bounds 
        PushD        $slice-string-index1      
        LoadI                                  
        JumpNeg      $$string-slice-index-error 
        PushD        $slice-string-index2      
        ...
        Exchange                               
        StoreI                                 
        Label        -string-slice-19-loop-start 
        PushD        $slice-string-index2      
        LoadI                                  
        PushD        $slice-string-index1      
        LoadI                                  
        Subtract                               
        JumpPos      -string-slice-19-loop-body 
        Jump         -string-slice-19-exit     
        Label        -string-slice-19-loop-body 
        PushD        $string-element-temp1     
        LoadI                                  
        LoadC                                  
        PushD        $string-element-temp2     
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-slice-19-loop-start 
        Label        -string-slice-19-exit     
        PushD        $record-creation-temp     
        LoadI                                  
        Call         $print-string             
        PushD        $print-format-space       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -string-slice-20-in-bounds 
        Jump         $$string-slice-index-error 
        Label        -string-slice-20-in-bounds 
        PushD        $slice-string-index1      
        LoadI                                  
        JumpNeg      $$string-slice-index-error 
        PushD        $slice-string-index2      
        ...
        Exchange                               
        StoreI                                 
        Label        -string-slice-20-loop-start 
        PushD        $slice-string-index2      
        LoadI                                  
        PushD        $slice-string-index1      
        LoadI                                  
        Subtract                               
        JumpPos      -string-slice-20-loop-body 
        Jump         -string-slice-20-exit     
        Label        -string-slice-20-loop-body 
        PushD        $string-element-temp1     
        LoadI                                  
        LoadC                                  
        PushD        $string-element-temp2     
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-slice-20-loop-start 
        Label        -string-slice-20-exit     
        PushD        $record-creation-temp     
        LoadI                                  
        Call         $print-string             
        PushD        $print-format-space       
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -string-slice-22-in-bounds 
        Jump         $$string-slice-index-error 
        Label        -string-slice-22-in-bounds 
        PushD        $slice-string-index1      
        LoadI                                  
        JumpNeg      $$string-slice-index-error 
        PushD        $slice-string-index2      
        ...
        Exchange                               
        StoreI                                 
        Label        -string-slice-22-loop-start 
        PushD        $slice-string-index2      
        LoadI                                  
        PushD        $slice-string-index1      
        LoadI                                  
        Subtract                               
        JumpPos      -string-slice-22-loop-body 
        Jump         -string-slice-22-exit     
        Label        -string-slice-22-loop-body 
        PushD        $string-element-temp1     
        LoadI                                  
        LoadC                                  
        PushD        $string-element-temp2     
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-slice-22-loop-start 
        Label        -string-slice-22-exit     
        PushD        $record-creation-temp     
        LoadI                                  
        Call         $print-string             
        PushD        $print-format-space       
        ...
        LoadI                                  
        Subtract                               
        JumpNeg      -array-indexing-23-in-bounds 
        Jump         $$index-out-of-bound      
        Label        -array-indexing-23-in-bounds 
        Nop                                    
        PushD        $a-indexing-array         
        LoadI                                  
        PushI        16                        
        ...
        LoadI                                  
        Subtract                               
        JumpPos      -string-slice-25-in-bounds 
        Jump         $$string-slice-index-error 
        Label        -string-slice-25-in-bounds 
        PushD        $slice-string-index1      
        LoadI                                  
        JumpNeg      $$string-slice-index-error 
        PushD        $slice-string-index2      
        ...
        Exchange                               
        StoreI                                 
        Label        -string-slice-25-loop-start 
        PushD        $slice-string-index2      
        LoadI                                  
        PushD        $slice-string-index1      
        LoadI                                  
        Subtract                               
        JumpPos      -string-slice-25-loop-body 
        Jump         -string-slice-25-exit     
        Label        -string-slice-25-loop-body 
        PushD        $string-element-temp1     
        LoadI                                  
        LoadC                                  
        PushD        $string-element-temp2     
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-slice-25-loop-start 
        Label        -string-slice-25-exit     
        PushD        $record-creation-temp     
        LoadI                                  
        Call         $print-string             
        PushD        $print-format-space       
        ...
        Exchange                               
        StoreI                                 
        Label        -char-string-add-26-loop-start 
        PushD        $string-length-temp       
        LoadI                                  
        JumpFalse    -char-string-add-26-exit  
        PushD        $string-element-temp2     
        LoadI                                  
        PushD        $string-element-temp1     
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -char-string-add-26-loop-start 
        Label        -char-string-add-26-exit  
        PushD        $record-creation-temp     
        LoadI                                  
        PushD        $global-memory-block      
        PushI        4                         
        ...
        Exchange                               
        StoreI                                 
        Label        -string-char-add-27-loop-start 
        PushD        $string-length-temp       
        LoadI                                  
        JumpFalse    -string-char-add-27-exit  
        PushD        $string-element-temp2     
        LoadI                                  
        PushD        $string-element-temp1     
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-char-add-27-loop-start 
        Label        -string-char-add-27-exit  
        PushD        $string-element-temp2     
        LoadI                                  
        PushD        $char-temp                
        LoadC                                  
        ...
        Exchange                               
        StoreI                                 
        Label        -string-reverse-28-loop-start 
        PushD        $string-length-temp       
        LoadI                                  
        JumpFalse    -string-reverse-28-exit   
        PushD        $string-element-temp2     
        LoadI                                  
        PushD        $string-element-temp1     
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-reverse-28-loop-start 
        Label        -string-reverse-28-exit   
        PushD        $record-creation-temp     
        LoadI                                  
        Call         $print-string             
        PushD        $print-format-newline     
        ...
        Exchange                               
        StoreI                                 
        Label        -string-reverse-29-loop-start 
        PushD        $string-length-temp       
        LoadI                                  
        JumpFalse    -string-reverse-29-exit   
        PushD        $string-element-temp2     
        LoadI                                  
        PushD        $string-element-temp1     
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-reverse-29-loop-start 
        Label        -string-reverse-29-exit   
        PushD        $record-creation-temp     
        LoadI                                  
        Call         $print-string             
        PushD        $print-format-newline     
        ...
        Exchange                               
        StoreI                                 
        Label        -string-reverse-30-loop-start 
        PushD        $string-length-temp       
        LoadI                                  
        JumpFalse    -string-reverse-30-exit   
        PushD        $string-element-temp2     
        LoadI                                  
        PushD        $string-element-temp1     
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-reverse-30-loop-start 
        Label        -string-reverse-30-exit   
        PushD        $record-creation-temp     
        LoadI                                  
        Call         $print-string             
        PushD        $print-format-newline     
        ...
        Exchange                               
        StoreI                                 
        Label        -string-reverse-31-loop-start 
        PushD        $string-length-temp       
        LoadI                                  
        JumpFalse    -string-reverse-31-exit   
        PushD        $string-element-temp2     
        LoadI                                  
        PushD        $string-element-temp1     
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-reverse-31-loop-start 
        Label        -string-reverse-31-exit   
        PushD        $record-creation-temp     
        LoadI                                  
        Call         $print-string             
        PushD        $print-format-newline     
        ...
        Exchange                               
        StoreI                                 
        Label        -string-reverse-32-loop-start 
        PushD        $string-length-temp       
        LoadI                                  
        JumpFalse    -string-reverse-32-exit   
        PushD        $string-element-temp2     
        LoadI                                  
        PushD        $string-element-temp1     
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-reverse-32-loop-start 
        Label        -string-reverse-32-exit   
        PushD        $record-creation-temp     
        LoadI                                  
        Duplicate                              
        JumpFalse    $$null-string             
        ...
        Exchange                               
        StoreI                                 
        Label        -string-reverse-34-loop-start 
        PushD        $string-length-temp       
        LoadI                                  
        JumpFalse    -string-reverse-34-exit   
        PushD        $string-element-temp2     
        LoadI                                  
        PushD        $string-element-temp1     
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -string-reverse-34-loop-start 
        Label        -string-reverse-34-exit   
        PushD        $record-creation-temp     
        LoadI                                  
        Duplicate                              
        JumpFalse    $$null-string             
