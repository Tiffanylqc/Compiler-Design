        ...
        Label        -function-definition-1-fib-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        Label        -compare-equal-10-arg1    
        PushD        $frame-pointer            
        LoadI                                  
        PushI        0                         
        Add                                    %% n
        LoadI                                  
        Label        -compare-equal-10-arg2    
        PushI        0                         
        Label        -compare-equal-10-sub     
        Subtract                               
        JumpFalse    -compare-equal-10-true    
        Jump         -compare-equal-10-false   
        Label        -compare-equal-10-true    
        PushI        1                         
        Jump         -compare-equal-10-join    
        Label        -compare-equal-10-false   
        PushI        0                         
        Jump         -compare-equal-10-join    
        Label        -compare-equal-10-join    
        Duplicate                              
        ...
        PushD        -function-definition-1-fib-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% n
        ...
        Label        -while-enter-15-continue-target 
        ...
        Label        -while-enter-15-break-target 
        Jump         -while-17-join            
        Label        -while-17-join            
        Halt                                   
