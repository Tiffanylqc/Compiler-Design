        ...
        Label        -function-definition-1-bill2-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        PushD        -function-definition-1-bill2-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        4                         
        Add                                    %% bill0
        ...
        Label        -function-definition-2-bill0-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        PushD        -function-definition-2-bill0-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        8                         
        Add                                    %% bill1
        DLabel       -function-body-25-return-addr 
        DataZ        4                         
        Jump         -function-body-25--end    
        Label        -function-definition-3-bill1-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        Subtract                               
        LoadI                                  
        PushD        -function-body-25-return-addr 
        Exchange                               
        StoreI                                 
        PushD        $frame-pointer            
        LoadI                                  
        ...
        PushD        -function-definition-3-bill1-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        12                        
        Add                                    %% billextra
        ...
        Label        -function-definition-4-billextra-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        PushD        -function-definition-4-billextra-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% a
        ...
        PushI        34                        
        Add                                    %% inside
        DLabel       -function-body-35-return-addr 
        DataZ        4                         
        Jump         -function-body-35--end    
        Label        -function-definition-5-inside-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        Exchange                               
        StoreI                                 
        Jump         -function-body-34--exit-handshake 
        Jump         $$no return               
        Label        -function-body-34--exit-handshake 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        8                         
        Subtract                               
        LoadI                                  
        PushD        -function-body-35-return-addr 
        Exchange                               
        StoreI                                 
        PushD        $frame-pointer            
        LoadI                                  
        ...
        LoadI                                  
        Return                                 
        Label        -function-body-35--end    
        PushD        -function-definition-5-inside-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        38                        
        Add                                    %% inside2
        DLabel       -function-body-37-return-addr 
        DataZ        4                         
        Jump         -function-body-37--end    
        Label        -function-definition-6-inside2-start 
        PushD        $frame-pointer            
        LoadI                                  
        PushD        $stack-pointer            
        LoadI                                  
        ...
        StoreI                                 
        Jump         $$no return               
        Label        -function-body-36--exit-handshake 
        PushD        $frame-pointer            
        LoadI                                  
        PushI        8                         
        Subtract                               
        LoadI                                  
        PushD        -function-body-37-return-addr 
        Exchange                               
        StoreI                                 
        PushD        $frame-pointer            
        LoadI                                  
        ...
        LoadI                                  
        Return                                 
        Label        -function-body-37--end    
        PushD        -function-definition-6-inside2-start 
        StoreI                                 
        PushD        $global-memory-block      
        PushI        16                        
        Add                                    %% a
